;(function webpackUniversalModuleDefinition(root, factory) {
  if (typeof exports === 'object' && typeof module === 'object')
    ...
    exports['el-table-ext'] = factory(require('vue'))
  else root['el-table-ext'] = factory(root['Vue'])
})(
...
*/
        ...
        /***/ a79d: /***/ function (module, exports, __webpack_require__) {
          'use strict'
        ...
        /***/ ab10: /***/ function (
          ...
          'use strict'
          /* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_9_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_9_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_9_oneOf_1_3_Table_scss_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__ =
            __webpack_require__('d2a3')
          /* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_9_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_9_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_9_oneOf_1_3_Table_scss_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0___default =
            /*#__PURE__*/ __webpack_require__.n(
              _node_modules_mini_css_extract_plugin_dist_loader_js_ref_9_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_9_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_9_oneOf_1_3_Table_scss_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__
            )
        ...
        /***/ d2a3: /***/ function (module, exports, __webpack_require__) {
        ...
        /***/ d6d6: /***/ function (module, exports, __webpack_require__) {
          var global = __webpack_require__('da84')
        ...
        /***/ fb15: /***/ function (
          ...
          // CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"11bb4fdb-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./lib/Table.vue?vue&type=template&id=40c3c70e&
          var render = function () {
            var _vm = this
                ...
                _vm._b(
                  {
                    ...
                    ref: 'table',
                    staticClass: 'el-table-ext',
                    attrs: {
                      data: _vm.tableData,
                      height: _vm.height,
                      'default-sort': _vm.defaultSort,
                      'empty-text': _vm.errorMessage || _vm.emptyText
                    },
                    on: {
                      'sort-change': _vm.sortChange,
                      'filter-change': _vm.filterChange,
                      'hook:mounted': _vm.tableMounted
                    }
                  },
                  'el-table-fix',
                  _vm.options,
                ...
                _vm._l(_vm.cols, function (col) {
                  return _c(
                    ...
                    _vm._b(
                      {
                        key: col.prop,
                        attrs: { 'column-key': col.prop },
                        scopedSlots: _vm._u(
                          [
                            _vm.$scopedSlots[col.prop]
                              ? {
                                  key: 'default',
                                  fn: function (scope) {
                                    return [
                              ...
                              : null,
                            _vm.$scopedSlots['header:' + col.prop]
                              ? {
                                  key: 'header',
                                  fn: function (scope) {
                                    return [
          ...
          // CONCATENATED MODULE: ./lib/Table.vue?vue&type=template&id=40c3c70e&
          ...
          // CONCATENATED MODULE: ./lib/ColumnRender.js

          // 表格列函数式渲染
          /* harmony default export */ var ColumnRender = {
            props: {
              render: {
                type: Function,
                required: true
          ...
          // CONCATENATED MODULE: ./lib/ElTableFix.js
          var ElTableFix = {
            name: 'ElTableFix',
            computed: {
              // 列表内容高度
            ...
            methods: {
              // 调整添加分页条后的内容高度
              fixBodyHeight: function fixBodyHeight(type) {
                var h = ElTableFix.extends.computed[type].call(this)
                var paginHeight = this.getPaginHeight()
                ...
                if (h.height) {
                  var height = parseInt(h.height) - paginHeight
                  h.height = height + 'px'
                } else if (h['max-height']) {
                  var _height = parseInt(h['max-height']) - paginHeight

                  h['max-height'] = _height + 'px'
                }

                return h
              },
              // 分页条高度
              getPaginHeight: function getPaginHeight() {
                var pagin = this.$parent.$refs.pagin
          ...
          /* harmony default export */ var lib_ElTableFix = ElTableFix
          // CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--13-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/eslint-loader??ref--14-0!./lib/Table.js?vue&type=script&lang=js&
          ...
          /* harmony default export */ var Tablevue_type_script_lang_js_ = {
                ...
                return this.columns.map(function (item) {
                  if (item.renderOption) {
                    _this.$set(
                      item,
                      'render',
                      _this.getOptionRender(item.renderOption)
                    )
                  } else if (typeof item.formatter === 'string') {
                    var formatter = _this.getFilterFormatter(item.formatter)

                    if (formatter) {
                      _this.$set(item, 'formatter', formatter)
                    } else {
                      _this.$delete(item, 'formatter')
                    }
                  }
            ...
            methods: {
              ...
              tableMounted: function tableMounted() {
                this.mounted = true // 移动分页节点

                if (this.pager) {
                  this.$el.appendChild(this.$refs.pagin.$el)
                }

                this.filters = this.getFilters() // 自动加载列表

                this.autoLoad && this.load()
              },
              // 选项渲染函数
              getOptionRender: function getOptionRender(option) {
              ...
              // 过滤器格式化
              getFilterFormatter: function getFilterFormatter(filterName) {
                // 获取全局过滤器
                var filter =
                  external_commonjs_vue_commonjs2_vue_root_Vue_default.a.filter(
                    filterName
                  )
              ...
              // 字段/表头作用域绑定
              bindScope: function bindScope(_ref2) {
                var row = _ref2.row,
                  column = _ref2.column,
                  index = _ref2.$index
              ...
              // 获取分页配置
              getPagin: function getPagin() {
                if (typeof this.pager === 'boolean') {
                  return defaultPager
                }

                return _objectSpread2(
                  _objectSpread2({}, defaultPager),
                  this.pager
                )
              },
              // 更改分页数
              ...
              getFilters: function getFilters() {
                var filters = {}
                this.$refs.table.columns.forEach(function (_ref4) {
                  var prop = _ref4.property,
                    value = _ref4.filteredValue
          ...
          // CONCATENATED MODULE: ./lib/Table.js?vue&type=script&lang=js&
          /* harmony default export */ var lib_Tablevue_type_script_lang_js_ =
            Tablevue_type_script_lang_js_
          // EXTERNAL MODULE: ./lib/Table.scss?vue&type=style&index=0&lang=scss&
          var Tablevue_type_style_index_0_lang_scss_ =
            __webpack_require__('ab10')
          ...
          // CONCATENATED MODULE: ./lib/Table.vue

          /* normalize component */

          var component = normalizeComponent(
            lib_Tablevue_type_script_lang_js_,
            render,
            staticRenderFns,
            false,
            null,
          ...
          var lib_install = function install(Vue) {
            ...
            lib_ElTableFix.extends = options.ElTable
            Vue.component(Table.name, Table)
          }

          Table.install = lib_install // 如果浏览器环境且拥有全局Vue，则自动安装组件

          /* if (typeof window !== 'undefined' && window.Vue) {
  window.Vue.use(ElTableExt)
} */

          /* harmony default export */ var lib = Table
...
//# sourceMappingURL=el-table-ext.umd.js.map
